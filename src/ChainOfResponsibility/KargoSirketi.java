...
public abstract class KargoSirketi {
    ...
    private static void hizmetAlaniDisiYazdir(EnumIl il) {
        System.out.println(il.getIl() + "Hizmet alaninin disindadir. ");
    }

    private void kargoTeslimBilgileriYazdir() {
        System.out.println(getEnumIl().getIl() + " şube teslim aldi");
    }
