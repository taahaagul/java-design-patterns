...
public class CovidAgırHastaSayisiVisitor implements Visitor {
    @Override
    ...
    private int hastaSayisiHesapla(Hastane hastane) {
        return HastaHesaplaUtil.hastaSayisiHesapla(hastane, EnumHastalik.COVID, EnumHastaDurumu.AGIRHASTA);
    }
