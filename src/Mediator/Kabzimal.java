...
public class Kabzimal implements Araci {
    ...
    private static void satisYap(Uretici uretici, Halci halci) {
        System.out.println(uretici.getAdi() + " isimli üretici " + halci.getAdi() +
                " isimli halciye " + uretici.getUrun().getUrun() + " satti.");
    }
}
