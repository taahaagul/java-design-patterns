...
public class EvBuilder {
    ...
    //Girilmesi zorunlu bıraktığımız constructor'ları böyle tanımlyıoruz..
    public static EvBuilder startBuild(String il, String ilce, String mahalle, int binaYili){
